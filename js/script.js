...
function tampilkanRumus() {
  ...
  switch(selectedOption) {
    case 'celsius-to-fahrenheit':
      desc = "\\text{Konversi suhu bertujuan untuk menyatakan suhu}\\\\ \\text{suatu benda dari satu skala ke skala lain.}\\\\ \\text{Nilai suhu } S \\text{ dalam derajat Fahrenheit (\\degree F)}\\\\ \\text{sama dengan suhu }  S \\text{ dalam derajat } \\\\ \\text{Celcius (\\degree C) kali } \\frac{9}{5} \\text{ ditambah } 32";
      rumusText = "\\Large S_{(\\degree F)} = (S_{(\\degree C)} \\times \\frac{9}{5}) + 32 \\\\ \\text{ } \\\\ \\text{atau} \\\\ \\text{ } \\\\ S_{(\\degree F)} = (S_{(\\degree C)} \\times 1.8) + 32";
      break;
    case 'fahrenheit-to-celsius':
      desc = "\\text{Konversi suhu bertujuan untuk menyatakan suhu}\\\\ \\text{suatu benda dari satu skala ke skala lain.}\\\\ \\text{Nilai Suhu } S \\text{ dalam derajat Celcius (\\degree C)}\\\\ \\text{sama dengan suhu }  S \\text{ dalam derajat } \\\\ \\text{Fahrenheit (\\degree F) dikurangi } 32 \\text{ kemudian kali } \\frac{5}{9}";
      rumusText = "\\Large S_{(\\degree C)} = (S_{(\\degree F)} - 32 ) \\times \\frac{5}{9}";
      break;
    case 'celsius-to-kelvin':
      desc = "\\text{Konversi suhu bertujuan untuk menyatakan suhu}\\\\ \\text{suatu benda dari satu skala ke skala lain.}\\\\ \\text{Nilai Suhu } S \\text{ dalam derajat Kelvin (\\degree K)}\\\\ \\text{sama dengan suhu }  S \\text{ dalam derajat } \\\\ \\text{Celcius (\\degree C) ditambah } 273.15";
      rumusText = "\\Large S_{(\\degree K)} = S_{(\\degree C)} + 273.15";
      break;
    case 'kelvin-to-celsius':
      desc = "\\text{Konversi suhu bertujuan untuk menyatakan suhu}\\\\ \\text{suatu benda dari satu skala ke skala lain.}\\\\ \\text{Nilai Suhu } S \\text{ dalam derajat Celcius (\\degree C)}\\\\ \\text{sama dengan suhu }  S \\text{ dalam derajat } \\\\ \\text{Kelvin (\\degree K) dikurangi } 273.15";
      rumusText = "\\Large S_{(\\degree C)} = S_{(\\degree K)} - 273.15";
      break;
    case 'fahrenheit-to-kelvin':
      desc = "\\text{Konversi suhu bertujuan untuk menyatakan suhu}\\\\ \\text{suatu benda dari satu skala ke skala lain.}\\\\ \\text{Nilai Suhu } S \\text{ dalam derajat Kelvin (\\degree K) sama}\\\\ \\text{dengan suhu }  S \\text{ dalam derajat Fahrenheit (\\degree F)}\\\\ \\text{dikurangi } 32 \\text{ kali } \\frac{5}{9} \\text{ ditambah } 273.15";
      rumusText = "\\Large S_{(\\degree K)} = (S_{(\\degree F)} - 32) \\times \\frac{5}{9} + 273.15";
      break;
    case 'kelvin-to-fahrenheit':
      desc = "\\text{Konversi suhu bertujuan untuk menyatakan suhu}\\\\ \\text{suatu benda dari satu skala ke skala lain.}\\\\ \\text{Nilai Suhu } S \\text{ dalam derajat Fahrenheit (\\degree F)}\\\\ \\text{sama dengan suhu }  S \\text{ dalam derajat Kelvin (\\degree K)}\\\\ \\text{dikurangi } 273.15 \\text{ kali } \\frac{9}{5} \\text{ ditambah } 32";
...
function headerselect(){
  const selectText = jenisKonversi.textContent;
}
// init script
hitungKonversi();
tampilkanCalc();
